...
from sqlalchemy import Column, String, Integer, DateTime, ForeignKey, CheckConstraint, Text, DECIMAL, UUID
import uuid
...
class User(db.Model):
    ...
    user_password_hash = db.Column(String(255), nullable=True) # Phải là True thì mới đăng nhập không cần mật khẩu được
